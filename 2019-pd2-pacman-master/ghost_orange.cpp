...
{
    setPixmap(QPixmap(":/img/ghost_orange.png").scaled(35,35));
}

int ghost_orange::shortestPath(int pacman, int tempMap[754], int distance,int K)
{
    //int K=find_block();
...
//        qDebug()<<"path[1]"<<path[1];
    ...
    {
        path[2]=shortestPath(pacman,tempMap,++distance,K+26);
